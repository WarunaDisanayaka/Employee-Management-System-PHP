        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">Create an Employee account</h2>
              ...
              <form action="empregister.php" method="POST">
                ...
                <p class="text-center text-muted mt-5 mb-0">Register as Company <a href="register.php"
