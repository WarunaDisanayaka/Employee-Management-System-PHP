...
$sql = "SELECT e.username, s.`month`, s.amount ,s.amount,s.companyid,e.id 
FROM employees e
LEFT JOIN salary s ON e.id = s.empid
WHERE s.companyid = '$companyid' AND e.id='$id' AND s.month='$month'";
...
<html lang="en">
         ...
         <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               <div class="container-fluid">
                  <!-- Page Heading -->
                  <h1 class="h3 mb-2 text-gray-800 text-center">Salary Management</h1>
                  <!-- DataTales Example -->
                  <div class="container mt-5 col-6">
                     ...
                     <input type="hidden" name="month" value="<?php echo $month ?>">
                        ...
                        <?php
                              foreach ($result as $r) {
                                 ?>
                                                          <option value="<?php echo $r['month'] ?>"><?php echo $r['month'] ?></option>
                                                          <?php
                              }
                              ?>
                        </select>
   ...
   <div class="form-group">
    ...
    <input type="number" class="form-control" name="amount" id="amountInput" placeholder="Enter amount" value="<?php echo $r['amount'] ?>">
</div>
